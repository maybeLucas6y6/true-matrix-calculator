...
bool ImGui::InputFloatN(const char* label, float* v, int components, const char* format, ImGuiInputTextFlags flags) {
    return InputScalarN(label, ImGuiDataType_Float, v, components, NULL, NULL, format, flags);
}
